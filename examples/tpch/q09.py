...
"""
from loader import load_lineitem, load_orders, load_part, load_nation, load_partsupp, load_supplier
import time
import argparse
import bodo
import pandas as pd
...
def q(data_folder):
    ...
    jn4 = partsupp.merge(jn3, left_on=["PS_PARTKEY", "PS_SUPPKEY"], right_on=["L_PARTKEY", "L_SUPPKEY"])
    jn5 = jn4.merge(orders, left_on="L_ORDERKEY", right_on="O_ORDERKEY")
    jn5['TMP'] = jn5.L_EXTENDEDPRICE * (1 - jn5.L_DISCOUNT) - ((1 * jn5.PS_SUPPLYCOST) * jn5.L_QUANTITY)
